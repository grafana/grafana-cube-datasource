...
import { detectUnsupportedFeatures, getUnsupportedQueryKeys, TEMPLATE_VARIABLE_PATTERN } from '../utils/detectUnsupportedFeatures';
        ...
        <FilterField
          filters={query.filters?.filter(
            (f): f is CubeFilter =>
              ...
              !f.values?.some((v) => TEMPLATE_VARIABLE_PATTERN.test(v))
          )}
